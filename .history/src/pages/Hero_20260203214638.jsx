  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* 선이 위에서 아래로 슥 흐르는 듯한 애니메이션 */}
          <div
            style={{
              width: "1px",
              height: "60px",
              background: "rgba(0, 0, 0, 0.05)", // 가이드 라인 (연한 배경선)
              position: "relative",
              overflow: "hidden",
            }}
          >
            <motion.div
              ...
              style={{
                width: "100%",
                height: "40%", // 전체 라인의 일부만 색상이 채워짐
                background:
                  "linear-gradient(to bottom, transparent, #7b61ff, transparent)",
              }}
            />
          </div>
        </div>
