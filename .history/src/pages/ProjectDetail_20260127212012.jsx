...
function ProjectDetail() {
    ...
    // ✅ Optional: support title broken into 2 lines (for highlight per line)
    // Add in projectsData: titleLines: ["Beverage Label", "Design"]
    const titleLines = project.titleLines;

    return (
        <div className="project-detail-page">
            <div className="project-detail-content">
                {/* ✅ Breadcrumb inside container so it aligns with the page content */}
                ...
                <div className="project-detail-header">
                    ...
                    <div className="project-detail-info">
                        {/* ✅ Title highlight supports 2-line layout if titleLines exists */}
                        ...
                        <div className="project-detail-meta-block">
                            <h3 className="project-detail-meta-title">
                                Summary
                            </h3>
                            <p className="project-detail-meta-text project-detail-preline">
                                {project.summary}
                            </p>
                        </div>
             ...
             ======================================== */}
                    ...
                    {slug === "can-design" && <CanDesign />}
                    {slug === "magazine" && <Magazine />}
                    {slug === "interactive_tutorial" && <InteractiveTutorial />}
                    {slug === "posters" && <Posters />}
                </div>
            </div>
        </div>
    );
