                ...
                <div className="about-me-intro">
                    ...
                    <div className="about-me-intro-right">
                        <p className="intro-text">
                            ...
                            inspired. With my colourful and fun design style, I
                            love creating intuitive and inclusive design. I
                            believe in the power of effective storytelling
                            through design. I enjoy designing unique,
                            eye-catching and playful visuals. Please take a
                            moment to browse my portfolio, and reach out to me
                            anytime if you have any inquiries. I’d love to hear
                            from you!
                        </p>
                    </div>
                </div>
                        ...
                        <div className="ilove-body">
                            ...
                            <div className="ilove-right">
                                <p className="ilove-list">
                                    Toast (my cat) • coffee • baking • desserts
                                    • cafés • hiking • beach • active lifestyle
                                    • browsing supermarkets • cute packaging
                                </p>
