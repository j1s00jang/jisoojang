                    ...
                    <div className="about-me-intro-right">
                        <p className="intro-text">
                            ...
                            <span className="intro-text-body">
                                I love identifying what causes friction and
                                turning it into a clear, structured product. To
                                create intuitive and inclusive experiences, I
                                use AI tools strategically to move faster in the
                                early stages of the design process, crafting
                                human-focused design and interfaces that only
                    ...
                    <div className="skills-content">
                        ...
                        <div className="skills-body">
                            <div className="hard-skills">
                                ...
                                <div className="skills-list-container">
                                    <p className="skills-list">
                                        ...
                                        figma (+ Figma Make), framer,
                                        blender(3d), Lovable, Uizard, base44,
                                        stitch
                                    </p>
                                    <p className="skills-list">
                                        generative AI, google analytics, content
                                        marketing, html5, css, javascript,
                            ...
                            <div className="soft-skills">
                                ...
                                <div className="skills-list-container">
                                    <p className="skills-list">
                                        adaptability, time management, clear
                                        communicator, cross-function
                                        collaborator, conflict resolution,
                                        detail-oriented, strong prioritization,
