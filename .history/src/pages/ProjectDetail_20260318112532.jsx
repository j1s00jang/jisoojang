...
function ProjectDetail() {
    ...
    const headerScreenImages = useMemo(() => {
        if (!project?.screenImages || !Array.isArray(project.screenImages))
            return [];
    ...
    const MD = ({ children, className = "project-detail-preline" }) => (
        <ReactMarkdown
            ...
            components={{
                ...
                li: ({ children }) => (
                    <li className="project-detail-li">{children}</li>
                ),
                                    ...
                                    {headerScreenImages.length > 1 && (
                                        <>
                                            <button
                                                ...
                                                onClick={() =>
                                                    setScreenCarouselIndex(
                                                        (i) =>
                                                            i > 0
                                                                ? i - 1
                                                                : headerScreenImages.length -
                                                                  1,
                                                    )
                                                }
                    ...
                    >
                        <div
                            className={`video-modal-container ${
                                ["magazine", "posters"].includes(slug)
                                    ? "modal-large"
                                    : ""
                            }`}
