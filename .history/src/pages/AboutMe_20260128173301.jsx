                ...
                <div className="about-me-intro">
                    ...
                    <div className="about-me-intro-right">
                        <p className="intro-text">
                            ...
                            <strong>experiences</strong>. With a strong interest
                            in <strong>accessibility</strong> and{" "}
                            <strong>inclusive</strong> design, I create products
                            that feel <strong>clear</strong>,{" "}
                            <strong>considerate</strong>,{" "}
                            <strong>thoughtful</strong>, and{" "}
                            <strong>easy</strong> to use for{" "}
                            <strong>diverse</strong> audiences.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="ilove-body">
                            ...
                            <div className="ilove-right">
                                <p className="ilove-list">
                                    my cat, Toast (11m) • coffee • baking •
                                    desserts • cafés • hiking • beach • active
                                    lifestyle • browsing supermarkets • cute
                                    packaging
                                </p>
                    ...
                    <div className="skills-content">
                        <div className="skills-header">
                            <h2 className="skills-title">
                                <span className="skills-title-text">
                                    i can do
                                </span>
                            </h2>
                        </div>
                        <div className="skills-body">
                            <div className="hard-skills">
                                ...
                                <div className="skills-list-container">
                                    <p className="skills-list">
                                        ...
                                        figma, framer, blender(3d), html5, css,
                                        javascript, react.js, next.js, node.js,
                                        express, expo, wordpress, google
                                        analytics, content marketing, seo, web
                                        security basics
                                    </p>
                                    <p className="skills-list">
                                        prototyping, wireframing, design &
                                        colour system, responsive ui design,
                                        interaction design, usability testing,
                                        accessibility (wcag), packaging design,
                                        typography
                                    </p>
                                </div>
                            </div>
                            <div className="soft-skills">
                                ...
                                <div className="skills-list-container">
                                    <p className="skills-list">
                                        time management, clear communicator,
                                        cross-function collaborator, conflict
                                        resolution, detail-oriented, strong
                                        prioritization, bilingual
                                        (english/korean)
                                    </p>
                                </div>
                            </div>
