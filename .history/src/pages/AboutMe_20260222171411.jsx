              ...
              <div className="hard-skills">
                ...
                <div className="skills-list-container">
                  <p className="skills-list">
                    ...
                    indesign, after effects), figma (+ Figma Make), framer,
                    blender(3d), Lovable, Uizard, base44, stitch
                  </p>
                  <p className="skills-list">
                    Marketing & Dev | generative AI, google analytics, content
                    marketing, html5, css, javascript, react.js, next.js,
                    node.js, express, expo, wordpress
                  </p>
                  <p className="skills-list">
