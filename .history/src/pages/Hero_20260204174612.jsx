        ...
        >
          <motion.img
            ...
            animate={{
              ...
              filter: [
                "brightness(1) drop-shadow(0px 0px 5px rgba(255,255,255,0))",
                "brightness(1.5) drop-shadow(0px 0px 15px rgba(255,255,255,0.9)) drop-shadow(0px 0px 30px rgba(255,255,255,0.4))",
                "brightness(1) drop-shadow(0px 0px 5px rgba(255,255,255,0))",
              ],
            }}
            transition={{
              ...
              filter: {
                duration: 3,
                repeat: Infinity,
                delay: 2.3, // clipPath 애니메이션이 끝나는 시점에 시작 (0.3 delay + 2 duration)
                ease: "easeInOut",
              },
            }}
            style={{
