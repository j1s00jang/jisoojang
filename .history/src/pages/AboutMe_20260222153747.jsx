        ...
        <div className="about-me-intro">
          <div className="about-me-intro-left">
            ...
            <div className="about-me-title">
              ...
              <p className="job-title">based in vancouver, ca</p>
            </div>
          </div>
          <div className="about-me-intro-right">
            <p className="intro-text">
              ...
              <span className="intro-text-body">
                Nature is my favourite colour palette to get inspired. With my
                colourful and fun design style, I love creating intuitive and
                inclusive design. I believe in the power of effective
                storytelling through design. I enjoy designing unique,
                eye-catching and playful visuals.
                <br />
                <br />
