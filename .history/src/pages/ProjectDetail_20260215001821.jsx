    ...
    >
      <div className="project-detail-content">
        ...
        <div className="project-detail-header">
          ...
          <div className="project-detail-info">
            ...
            {(project.id === 1 || project.id === 2) && (
              <div className="project-detail-intro-block">
                <h3 className="project-detail-intro-title">Timeline</h3>
                <p className="project-detail-intro-text project-detail-preline">
                  {project.timeline}
                </p>
              </div>
        ...
        <div className="project-detail-body">
          ...
          {/* Scaffold 전용 컴포넌트에는 onImageClick 기능을 위해 
              필요하다면 setZoomedImage를 prop으로 넘길 수도 있습니다. */}
          {slug === "scaffold" && (
            <Scaffold
              project={project}
