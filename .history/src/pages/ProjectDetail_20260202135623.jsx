        ...
        <div className="project-detail-body">
          ...
          {project.overview && (
            <section className="project-detail-section">
              <h2>Overview</h2>
              <p className="project-detail-preline">{project.overview}</p>
          ...
          {(project.id === 1 || project.id === 2) && project.opportunity && (
            <>
              <section className="project-detail-section opportunity-section">
                <h2>Opportunity</h2>
                <p className="project-detail-preline">{project.opportunity}</p>
              </section>

              <section className="project-detail-section my-role-section">
                <h2>My Role</h2>
                <p className="project-detail-preline">{project.myRole}</p>
              </section>

              <section className="project-detail-section">
                <h2>User Research</h2>
                <p className="project-detail-preline">{project.userResearch}</p>
              </section>
            </>
          )}
