          ...
          <div className="about-me-intro-right">
            <p className="intro-text">
              ...
              <span className="intro-text-body">
                Nature is one of my favourite places to find colour inspiration.
                I love turning complex ideas into intuitive and inclusive
                experiences. By using AI tools strategically to move faster in
                the early stages of the design process, I craft human-centred
