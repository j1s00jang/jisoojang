...
import HelloStickerHover from "../assets/main/hero/iam_UXUI.svg";
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* 스티커들 (img로 색상 유지) */}
                {stickers.map(({ id, src, hoverSrc, style }) => {
                    const isHovered = hoveredId === id;
                    const displaySrc = hoverSrc && isHovered ? hoverSrc : src;
                    return (
                        <div
                            key={id}
                            ...
                            style={{
                                ...
                                cursor: hoverSrc ? "pointer" : "default",
                            }}
                        >
                            <img
                                src={displaySrc}
