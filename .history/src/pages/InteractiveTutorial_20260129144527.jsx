...
function InteractiveTutorial({ project }) {
    ...
    return (
        <>
            ...
            <section className="project-detail-section">
                <h2>Try out the prototype</h2>
                <FigmaEmbed
                    title="Hello, My First Cat! Prototype"
                    figmaUrl="https://www.figma.com/proto/eMqTulTEWvaUaudlk26b3F/Design3-CP05-Hello--My-First-Cat-?node-id=112-444&t=fEIEYjjknlKJ727W-1"
