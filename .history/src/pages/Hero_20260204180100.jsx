        ...
        >
          ...
          <img
            ...
            style={{
              ...
              top: 0,
              left: 0,
              // #C7C8FF 색상을 구현하기 위해 drop-shadow를 겹쳐서 사용합니다.
              filter:
                "brightness(0) invert(1) sepia(1) saturate(5) hue-rotate(190deg) blur(25px)",
              opacity: 0.6, // 빛의 세기 조절
              zIndex: -1,
              transform: "scale(1.05)", // 리본보다 살짝 크게 설정하여 테두리 밖으로 빛이 나오게 함
            }}
          />
          <motion.img
            src={RibbonUrl}
