...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
        ...
        },
        {
            paragraphs: [
                ...
                `&nbsp;`,
                `Scaffold's next steps are expanding into more grants and regions, and adding more features to help users find and apply for grants easier and faster. While keeping Scaffold's core proposition of helping tradespeople find financial support, so that no tradespeople has to pause or stop a career path due to a lack of accessible financial support.`,
            ],
        },
    ],
};
