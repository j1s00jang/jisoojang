...
export const montro = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        `Survey results from 10 participants pointed out that expense tracking often relies on familiar, long-standing routines...`,
      ],
      slides: [
        { src: montroUserResearch1, alt: "User Research Survey Result 1" },
        { src: montroUserResearch2, alt: "User Research Survey Result 2" },
      ],
      caption:
        "Survey summary: Participants relied more on their existing habits.",
      imageLayout: "row",
    },
    {
      heading: "Insights",
