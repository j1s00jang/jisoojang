...
export const montro = {
    ...
    sections: [
        ...
        },
        {
            ...
            paragraphs: [
                "High habit formation potential: Despite frustrations, 55.6% have made tracking a regular habit, indicating that with the right features, more users could be nudged into consistent behaviour.",
