...
export const scaffold = {
  ...
  overview: `Skilled tradespeople often missed grant deadlines or gave up looking for funding because the process was spread across multiple websites. **Scaffold** is an all-in-one financial resource app designed to help users find relevant grants, track deadlines, and stay organized in one place. As the project scope expanded, multiple features competed for attention, making it challenging to maintain a clear and usable core experience. Reliability and performance also became more important over time, requiring careful prioritization and ongoing refinement.`,
  headerLinks: [
    {
