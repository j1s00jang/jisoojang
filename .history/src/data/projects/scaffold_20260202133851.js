...
export const scaffold = {
  ...
  sections: [
    ...
    {
      paragraphs: [
        "2. Direct path to official applications \n Because most grants are completed on external sites, each grant card includes a direct link to the official application page. This reduces unnecessary searching and cuts down on repeated website-hopping.",
      ],
    },
    {
      paragraphs: [
        "3. Profile + web supplement to reduce repeated work \n Many grant applications ask for the same information. Scaffold uses a saved profile based on commonly required personal and education questions, so details can be copied and reused to reduce repetitive typing and prevent small errors. Since essay writing on a phone is inconvenient, a web supplement supports drafting on a larger screen. It also includes AI-assisted first-draft support using saved profile details, plus a simple list for tracking applied grants and deadlines.",
      ],
      images: [
        {
          type: "video",
    ...
    {
      paragraphs: [
        "This project became a strong foundation for growth in UI/UX design—from early research and ideation to a full prototype and live demo. It strengthened communication and teamwork, supported by ongoing feedback and guidance from BCIT instructors throughout the process.",
        "\nWhat I learned & strengthened from this experience:",
        "\n- End-to-end UI/UX growth: built skills from early research and ideation to a full prototype and live demo.",
        "- Clearer communication and teamwork: improved collaboration through feedback and guidance from BCIT instructors.",
        "- Stronger storytelling and decisions: pitch day helped strengthen clear storytelling and structured decision-making.",
        "- Better iteration mindset: learned to experiment, take feedback, and improve after setbacks.",
        "\n Pitch day was a meaningful milestone: presenting the journey from early ideas to a developed product to a large audience helped clarify the value of clear storytelling and structured decision-making. Most importantly, the project encouraged experimentation and iteration—treating setbacks as signals for improvement and building a more confident, resilient design approach.",
      ],
    },
  ],
};
