...
export const scaffold = {
    ...
    overview: `**Scaffold is an all-in-one AI-assisted financial resource platform that helps skilled tradespeople find grants* they’re actually eligible for. Funding information is scattered, outdated, and time-consuming to evaluate. Scaffold filters all eligible grants to apply easily and quickly based on the user’s profile created in the early stage. With a web supplement, users complete an essay with AI-assistant to help them with the application process.`,
    headerLinks: [
        {
...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
        ...
        },
        {
            ...
            paragraphs: [
                ...
                `Grant information is spread across multiple websites, making it difficult to find reliable details and stay on top of deadlines. In the survey, 75% of respondents selected "Don't know where to find information about grants",  and 50% selected "Don't know what's available", "Application processes are too complicated" (Sselect all that apply). Overall, the results showed that missed deadlines are not only about eligibility, but also about the difficulty of finding and applying for grants.`,
            ],
            images: [
                {
