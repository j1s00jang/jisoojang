...
export const scaffold = {
    ...
    overview: `**Scaffold is an AI-assisted, all-in-one financial resource platform** that helps skilled tradespeople find eligible grants to advance their careers without financial struggles.
    Funding information is scattered, outdated, and time-consuming to evaluate. **Scaffold filters all eligible grants to apply easily and quickly** based on the user’s profile created in the early stage. With a web supplement, users complete an essay with an AI-assistant.`,
    headerLinks: [
        {
...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
            ...
            images: [
                {
                    ...
                    caption:
                        "Simplified user research (Primary, Secondary) findings",
                    openInModal: true,
                },
            ],
        ...
        },
        {
            ...
            paragraphs: [
                ...
                including creating a profile and applying eligible grants. **3m** to re-applying eligible grants, exluding essay writing`,
