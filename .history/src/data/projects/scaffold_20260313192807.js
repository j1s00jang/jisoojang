...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
        ...
        },
        {
            ...
            paragraphs: [
                ...
                `&nbsp;`,
                `Overall, the results showed that missed deadlines are not only about eligibility, but also about the difficulty of finding and applying for grants. Many people gave up on grants because they didn't know where to find information about grants, didn't know what's available, and the application processes are too complicated.`,
            ],
            images: [
                {
