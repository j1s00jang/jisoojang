...
export const montro = {
  ...
  sections: [
    ...
    },
    {
      heading: "Insights",
      paragraphs: [
        `Insights showed that awareness alone doesn’t sustain expense tracking—consistency does. Long-term habit formation requires low-friction logging plus reinforcement (progress feedback and rewards) to prevent drop-off. These findings guided Montro’s values and clarified what the product must deliver. The user persona below represents the target user’s goals, barriers, and triggers that shaped the key experience decisions.`,
        `&nbsp;`,
      ],
      images: [
        {
