...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
        ...
        },
        {
            ...
            paragraphs: [
                ...
                `&nbsp;`,
                `Purple and orange were selected to balance trust and energy in a data-heavy mobile experience. Purple anchors the brand with a calm, confident tone supporting focus. Orange is reserved for moments that require action, using contrast to draw attention to primary CTAs and key highlights without adding visual noise. Typography follows the same principle: one typeface supports a strong hierarchy for titles and labels, while a highly legible typeface is used for longer content to reduce reading fatigue on small screens.`,
                `&nbsp;`,
            ],
        },
        {
