...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
    ...
    {
      paragraphs: [
        `- **AI-powered voice-over profile + web supplement to reduce repeated work** : Grant applications repeatedly ask for the same personal and educational details, which leads to tedious retyping and small errors. This concept captures key information once through an AI voice-over intake (useful on-the-go), then saves it as a reusable profile that can be copied into future applications. Because essay drafting on a phone is inconvenient, a companion web experience supports writing on a larger screen, including AI-assisted first-draft help that pulls from the saved profile details for faster, more consistent submissions.`,
      ],
    },
    {
      images: [
