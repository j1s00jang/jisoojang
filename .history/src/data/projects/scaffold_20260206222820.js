...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
    ...
    {
      paragraphs: [
        `- **AI-powered voice profile for easy setup:** : Users can build a profile with voice input on the go. The AI captures key details even with unclear speech. The profile can be reused and helps filter eligible grants on the dashboard.`,
      ],
    },
    {
      paragraphs: [
