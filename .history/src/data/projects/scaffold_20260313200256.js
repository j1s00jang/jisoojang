...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
        ...
        },
        {
            ...
            paragraphs: [
                ...
                `&nbsp;`,
                `The visual identity was built by a combination of purple and orange. The purple was used as the main brand colour to make Scaffold easy to recognize. Orange was used to give an energetic feel to highlight important actions and key information. Two fonts are used to balance style and readability. To structure information hierarchy, bold font is used for titles and labels while legible font is used for longer text with special consideration to mobile usage.`,
                `&nbsp;`,
            ],
            images: [
                {
