...
export const canDesign = {
  id: 3,
  name: "Beverage label design: Fizzypop",
  titleLines: ["Beverage label design : Fizzypop"],
  slug: "can-design",
  category: "graphic design",
  thumbnail: canDesignThumbnail,
  screenImage: canDesignScreen,
  summary:
    "A label designed with a product interface, prioritizing I/A, layout rules with clear navigation of product details",
  ...
  carouselImages: [labelTomato, labelOrange, labelGrape],
