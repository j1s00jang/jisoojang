...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
        ...
        },
        {
            paragraphs: [
                ...
                `- **Time saved (timed usability test, n=5):** Traditional workflow average 112 min (Google search → eligibility review → application drafting). With Scaffold average **15 min** including creating a profile, **3m** to applying eligible grants exluding essay writing`,
