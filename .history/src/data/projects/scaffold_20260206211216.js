...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
    ...
    {
      paragraphs: [
        `- **AI-powered voice-over profile + web supplement to reduce repeated work** : Many grant applications ask for the same information. By creating a profile based on commonly required personal and educational questions, the details can be copied and reused to reduce repetitive typing and prevent small errors. Since essay writing on a phone is inconvenient, a web supplement supports drafting on a larger screen, including AI-assisted first-draft support using saved profile details.`,
      ],
    },
    {
      images: [
