...
export const scaffold = {
    ...
    overview:
        "Skilled tradespeople often missed grant deadlines or gave up looking for funding because the process was spread across multiple websites. <strong>Scaffold</strong> is an all-in-one financial resource app designed to help users find relevant grants, track deadlines, and stay organized in one place.",
