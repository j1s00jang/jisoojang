...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
        ...
        },
        {
            ...
            paragraphs: [
                ...
                `Grant information is spread across multiple websites, making it difficult to find reliable details and stay on top of deadlines. In the survey, 75% of respondents selected "Don't know where to find information about grants", and over 50% selected "Don't know what's available", "Application processes are too complicated", "Changed my career path because of financial struggles" (Select all that apply).`,
                `&nbsp;`,
