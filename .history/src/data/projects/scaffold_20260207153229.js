  ...
  sections: [
    {
      heading: "Opportunity",
      paragraphs: [
        `Scaffold project focuses on helping users quickly discover grants and financial information that can be used on the go. A key challenge was reducing friction in the application process while keeping content clear and easy to navigate on a small screen. The key focus was to make grant information simpler to find, easier to understand, and faster to act on, so fewer deadlines and funding options will be missed.`,
...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
    ...
    },
    {
      heading: "My role",
      paragraphs: [
        `Created a dashboard UX, UI consistency, marketing print materials, and video storytelling:`,
        `&nbsp;`,
        ...
        `- Solely crafted the visual identity and layout of the brochure and business card.`,
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `Grant information are spread across multiple websites, making it difficult to find reliable details and stay on top of deadlines. The survey results below highlight the most common challenges and needs shared during early research.`,
      ],
