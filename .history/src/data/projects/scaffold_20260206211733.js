...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
    ...
    {
      paragraphs: [
        `- **AI-powered voice-over profile + web supplement to reduce repeated work** : Grant applications repeatedly ask for the same personal and educational details, which leads to tedious retyping and small errors. This concept lets users save their personal and education info once using voice input. It works well on the go or with one hand, and the AI can still pick out the key details even if the speech isn’t perfect. The saved profile can be reused to auto-fill or copy into future applications, reducing repeat typing and small mistakes. For essays, a web version supports writing on a bigger screen and offers AI help to create a first draft using the saved profile info.`,
      ],
    },
    {
      images: [
