...
3. Reduce repetitive typing to lower frustration and speed up applications.`,
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `Grant information is spread across multiple websites, making it difficult to find reliable details and stay on top of deadlines. We conducted the survey, 75% of respondents answered "Don't know where to find information about grants.",  50% said "Don't know what's available", "Application processes are too complicated.". (Results were select all that apply) Based on the user's survey, the main reason was found that missing grants deadlines was not just about eligibility but also about the difficulty in finding and applying for grants.`,
      ],
    },
    {
      images: [
