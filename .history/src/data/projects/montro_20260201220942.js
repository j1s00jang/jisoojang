...
export const montro = {
    ...
    overview:
        "Montro is a gamified expense-tracking app that transforms the mundane task of tracking expenses into an engaging and rewarding experience. The app uses behavioral psychology principles to encourage better spending habits.",
