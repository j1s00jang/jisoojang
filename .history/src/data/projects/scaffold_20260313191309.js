...
export const scaffold = {
    ...
    summary:
        "AI-assisted, all-in-one financial resource platform that helps skilled tradespeople find eligible grants to keep moving their careers forward without giving up because of financial struggles",
