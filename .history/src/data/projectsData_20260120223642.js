...
export const projects = [
  { 
    ...
    overview: 'More than 85% of skilled tradespeople struggled missing grant deadlines or abandoning their search for financial information due to the friction of navigating multiple websites. Scaffold is an all-in-one financial resource app designed to support users in managing their financial situations. Ensuring fundamental usability was challenging as disparate features and experiments competed for attention. As scope expanded, reliability and performance issues also grew, requiring careful prioritization and refinement. Scaffold was released at BCIT in December 2025.'
